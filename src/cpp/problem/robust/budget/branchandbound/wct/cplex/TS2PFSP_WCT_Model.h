...
#ifndef FLOWSHOP_SOLVER_TS2PFSP_WCT_MODEL_H
#define FLOWSHOP_SOLVER_TS2PFSP_WCT_MODEL_H
 ...
 */
class TS2PFSP_WCT_Model : public PFSP_WCT_ModelStrategy {
public:
    TS2PFSP_WCT_Model() {  }
    ~TS2PFSP_WCT_Model()  {  }
...
#endif //FLOWSHOP_SOLVER_TS2PFSP_WCT_MODEL_H
