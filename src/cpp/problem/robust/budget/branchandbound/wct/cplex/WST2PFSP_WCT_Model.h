...
#ifndef FLOWSHOP_SOLVER_WST2PFSP_WCT_Model_H
#define FLOWSHOP_SOLVER_WST2PFSP_WCT_Model_H
 ...
 */
class WST2PFSP_WCT_Model : public PFSP_WCT_ModelStrategy {
public:
    WST2PFSP_WCT_Model() {  }
    ~WST2PFSP_WCT_Model()  {  }
...
#endif //FLOWSHOP_SOLVER_WST2PFSP_WCT_Model_H
