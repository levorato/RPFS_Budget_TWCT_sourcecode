...
#ifndef FLOWSHOP_SOLVER_TS3PFSP_WCT_Model_H
#define FLOWSHOP_SOLVER_TS3PFSP_WCT_Model_H
 ...
 */
class TS3PFSP_WCT_Model : public PFSP_WCT_ModelStrategy {
public:
    TS3PFSP_WCT_Model() {  }
    ~TS3PFSP_WCT_Model()  {  }
...
#endif //FLOWSHOP_SOLVER_TS3PFSP_WCT_Model_H
