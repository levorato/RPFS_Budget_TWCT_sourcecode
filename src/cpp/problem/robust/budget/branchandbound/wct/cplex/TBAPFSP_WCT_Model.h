...
#ifndef FLOWSHOP_SOLVER_TBAPFSP_WCT_Model_H
#define FLOWSHOP_SOLVER_TBAPFSP_WCT_Model_H
 ...
 */
class TBAPFSP_WCT_Model : public PFSP_WCT_ModelStrategy {
public:
    TBAPFSP_WCT_Model() {  }
    ~TBAPFSP_WCT_Model()  {  }
...
#endif //FLOWSHOP_SOLVER_TBAPFSP_WCT_Model_H
