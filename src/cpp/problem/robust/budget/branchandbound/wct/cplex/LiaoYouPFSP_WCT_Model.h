...
#ifndef FLOWSHOP_SOLVER_LIAOYOU_PFSP_WCT_MODEL_H
#define FLOWSHOP_SOLVER_LIAOYOU_PFSP_WCT_MODEL_H
 ...
 */
class LiaoYouPFSP_WCT_Model : public PFSP_WCT_ModelStrategy {
public:
    LiaoYouPFSP_WCT_Model() {  }
    ~LiaoYouPFSP_WCT_Model()  {  }
...
#endif //FLOWSHOP_SOLVER_LIAOYOU_PFSP_WCT_MODEL_H
