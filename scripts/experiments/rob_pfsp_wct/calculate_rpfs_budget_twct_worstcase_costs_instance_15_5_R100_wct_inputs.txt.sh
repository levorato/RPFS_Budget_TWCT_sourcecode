...
/users/ubuntu/julia-1.6.0/bin/julia calculate_rpfs_budget_twct_worstcase_costs.jl --machine=$SLURMD_NODENAME --instances=instance_15_5_R100_wct_inputs.txt
